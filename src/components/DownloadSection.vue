        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            ...
            <v-col cols="12" sm="8" class="white--text text-left">
              <h1 class="font-weight-light display-2 mb-2">En MecaNet...</h1>
              <h1 class="font-weight-light">
                facilitaremos el monitoreo de reparaciones de sus vehículos, la autenticidad y proceso de la reparación y la búsqueda de un taller de acuerdo a sus necesidades 
              </h1>
